...
(function (scenes) {
    ...
    var Play3 = (function (_super) {
        ...
        Play3.prototype.setupScoreboard = function () {
            ...
            this.health = 3;
            // Add health Label
            this.healthLabel = new createjs.Text("LIVES: " + this.health, "40px Consolas", "#ffffff");
            ...
            // Add Score Label
            this.scoreLabel = new createjs.Text("SCORE: " + this.score, "40px Consolas", "#ffffff");
        ...
        Play3.prototype.addBlocks = function () {
            for (var i = 0; i < this.blockCount; i++) {
                ...
                this.block = new Physijs.ConvexMesh(new BoxGeometry(x, 1, z), Physijs.createMaterial(new LambertMaterial()), 0);
                var rand = Math.floor(Math.random() * 20) - 10;
                this.block.position.set(rand, 1, i * -15);
                this.block.name = "Ground";
                this.add(this.block);
            }
        };
        /**
        ...
        Play3.prototype.sendBall = function () {
            this.ball = new Physijs.ConvexMesh(new SphereGeometry(0.5, 32, 32), Physijs.createMaterial(new LambertMaterial({ color: 0xff0000 })), 1);
            ...
            this.player.addEventListener('collision', function (event) {
                ...
                if (event.name === "Lava") {
                    ...
                    if (this.health <= 0) {
                        ...
                        this.healthLabel.text = "LIVES: " + this.health;
